...
var startExpressServer = testResources.startExpressServer;
var expressServerCloser = testResources.closeExpressServer;

var startServerListening = function * (expressApp) {    
...
var validateExpressApp = function(expressApp) {
    if (!expressApp || typeof expressApp !== 'function' || (expressApp.address && expressApp.address())) {
        throw new Error("You must specify the express app to use. This app must not yet be listening.");
    }
}
...
var startServer = function (expressApp, done) {
    ...
    Q.spawn(function * () {
        ...
        try {
            var runningServer = yield * startServerListening(expressApp);
